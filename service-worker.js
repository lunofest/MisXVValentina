const CACHE_NAME = 'cache-v4'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v4',
    'estilos/styles.css?v4',
    'estilos/mediaQueries.css?v4',
    'javascript/script.js?v4',
